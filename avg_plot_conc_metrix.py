...
#subjects = ['sev01', 'sev02', 'sev03','sev05', 'sev04', 'sev06','sev07', 'sev08','sev09','sev10']
...
# 计算功能性连接（信号包络之间的相关性）
correlation_matrix = np.corrcoef(raw_combined.get_data())  #注意这里一定要有get_data 不然会一直报错《19 channels
...
#connection_metrixname=f'connection_metrix.png'
...
fig, ax = plt.subplots(figsize=(9, 9), facecolor='white',dpi=150,
                       subplot_kw=dict(polar=True))
from matplotlib import cm
plot_connectivity_circle(correlation_matrix, channels_of_interest,n_lines=140,vmin=0, vmax=1,
                        textcolor='black', node_edgecolor='white',facecolor='white',colormap=cm.coolwarm,
                          colorbar_pos=(-0.3, 0.11),ax=ax,padding=3, fontsize_colorbar=6)
